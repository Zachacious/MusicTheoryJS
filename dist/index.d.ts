...
export { Note, Semitone, Modifier, Instrument, Scale, ScaleTemplates, Chord, ChordTemplates, };
export type { NoteInitializer, ScaleInitializer, ChordInitializer, ChordInterval, };
